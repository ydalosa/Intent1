...
import com.dam.snippets.a5_list.A52_Spinner;
import com.dam.snippets.a5_list.A53_RecyclerView;
...
public class A0_AccueilActivity extends AppCompatActivity {
    ...
    // Les listes
    TextView tvListView, tvListeSpinner, tvListeRecycler;
    ...
    private void initUI(){
        ...
        tvListeSpinner = findViewById(R.id.tvListeSpinner);
        tvListeRecycler = findViewById(R.id.tvListeRecyclerView);
    }
    ...
    private void clicSpinner() {
        tvListeSpinner.setOnClickListener(new View.OnClickListener() { // Gestion du clic avec le listener
            @Override
            public void onClick(View view) {
    ...
    private void clicRecycler() {
        tvListeRecycler.setOnClickListener(new View.OnClickListener() { // Gestion du clic avec le listener
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(A0_AccueilActivity.this, A53_RecyclerView.class);
                startActivity(intent);
            }
        });
    }
